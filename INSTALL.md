...
## Stage 0b — (moved) Connectors now run at the close, as Stage 9.3

**Do NOT ask for Gmail / Calendar / Drive / Notes access here.** Connecting apps takes ~5 minutes of OAuth, none of it is used during the install, and asking a stranger to grant Google access *before* the security audit — before they've seen a single thing work — burns trust at the exact moment you're trying to earn it.

It now runs at **Stage 9.3**, after the aha-moment, when they've watched you work for an hour and actually want to hand you more. Same content, far better moment.
...
## Stage 0 — The roadmap + tone-setting (~1 min)

**Don't greet again** — you already said hello in Stage 0a. Continue the same conversation: set expectations, get permission to proceed.

> "Right — here's the plan. I'm installing **Part 1: Foundation**, the first of three sittings. Here's the deal:
>
...
### Stage 9.3 — Connect your apps (~5 min, NOW — not before)

They've just watched you build something that works and heard your voice on their phone. *This* is the moment to ask for keys to the inbox — not hour zero.
...
> "One last optional thing, now that you've seen me work. Right now I can't see your inbox or your calendar — connecting them is what turns tomorrow's morning brief from *generic* into *yours*. Each takes about a minute. Skip any you don't use.
>
> | App | What you'll be able to ask me tomorrow |
> |---|---|
...
>
> In Claude Code Desktop: profile (top right) → **Settings → Connectors**. Tap **Add** on the ones you want — I'll watch the browser and confirm each one."
...
**If they skip some or all:**

> "Totally fine — everything we built still works. Say *'connect my Gmail'* anytime and we'll do it in a minute."

```bash
echo "connectors-deferred: $LIST_OF_SKIPPED" >> ~/[AI_NAME]/.first-run-log.txt
```

**Hard rules:** never gate anything on connectors · connect only what they actually use (no point with Gmail if they live in iCloud Mail) · verify with a real call, never trust "I clicked it" · one nudge max post-install (the wrap-up skill checks the deferred log once after 3 days, then never again).
